...
conversion = torch.tensor([
    HAR2EV, HAR2EV, HAR2EV, 1., HAR2EV, HAR2EV, HAR2EV, HAR2EV, HAR2EV,
...
class QM9(InMemoryDataset):
    ...
    raw_url = ('https://raw.githubusercontent.com/cahsmann/QM9_HoF/main/qm9_HoF.zip')
    ...
    def raw_file_names(self):
        return ['gdb9.sdf', 'qm9_HoF.csv', 'uncharacterized.txt']
    ...
    def process(self):
        with open(self.raw_paths[1], 'r') as f:
            target = f.read().split('\n')[1:-1]
            target = [[float(x) for x in line.split(',')[3:len(line)]]
                      for line in target]
