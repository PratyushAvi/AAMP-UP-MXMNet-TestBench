...
# my args
parser.add_argument('--scale', type=float, default=0.01, help='Percentage of the entire dataset')
parser.add_argument('--runtime', type=int, default=5, help='Maximum time to run the model')
...
SET_RUNTIME = args.runtime

print("Enter Set Scale (0 - 1): ", SET_SCALE)
print("Enter run time in minutes: ", SET_RUNTIME)
...
with open('./benchmarks/csv_data/%s_%.2f_%d_%d_graph_data.csv' % (targets[args.target], SET_SCALE * 100, my_epochs, SET_RUNTIME), 'w', newline='') as file:
